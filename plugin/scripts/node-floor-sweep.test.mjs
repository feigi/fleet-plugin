...
const API_FLOORS = [
  ...
  // Using the introduction version as the floor: it exists and is usable (with
  // an experimental warning) from 20.12.0, and this table's job is "what
  // version must a consumer run", not "warning-free". Matched at the import or
  // require site, same discipline as util.parseArgs() above: every unanchored
