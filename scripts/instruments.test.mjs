...
// The plugin IS the repo root now, so the instrument set is the repo's own
// component dirs rather than a subtree. "." keeps every join() below reading
// as "under the set" instead of restating the root at each site.
const SET = ".";
