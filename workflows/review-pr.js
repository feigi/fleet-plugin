...
function unrunReason(review) {
  ...
  if (!run.fail && typeof run.pass === "number" && run.pass * 2 < run.tests)
    return `\`${cmd}\` passed ${run.pass} of the ${run.tests} tests it collected and failed none — most of what it collected never ran`;
