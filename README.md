...
Requires Node 20 or newer (the floor the shipped scripts actually need); they
run under your own `node`. `.nvmrc` pins the dev/CI runtime the suite is
verified against — a different, higher number, and not a floor
