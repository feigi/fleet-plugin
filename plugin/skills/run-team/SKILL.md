...
>
> Three consequences, none of which `git status` can surface. **A bare
> top-level name is a shared global** a sibling can overwrite between two of
> your own cells, so prefix what you bind with your own member number
