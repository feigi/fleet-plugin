...
of duplicating it, and it is not for display, not for grouping, and not domain
data. It is a harness path fragment, so a change to how transcripts are stored
