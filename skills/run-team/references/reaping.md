...
Check: `node --test scripts/release-ticket.test.mjs` — real throwaway repos, only `gh` stubbed, one case per precondition proving it blocks on its own.
