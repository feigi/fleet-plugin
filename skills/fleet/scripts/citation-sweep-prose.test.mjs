...
const FILES = [
  ...
  {
    path: ["skills", "fleet", "scripts", "run-merge-bot-prose.test.mjs"],
  ...
  {
    path: ["skills", "fleet", "skills", "run-team", "SKILL.md"],
    stale: [/board\.mjs:153/],
